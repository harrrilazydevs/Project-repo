<div class="burger_machine_nav shadow" style="position:absolute; top:0; width:100vw; margin:0px;">

    <i class="fa-solid fa-bars icon_btn ps-3 pt-3 h5" style="position:relative;float:left" data-bs-toggle="offcanvas" href="#burger_machine_sidebar" role="button"></i>

    <div class="row" style=" font-size:15pt;">
        <div class="col-7 text-end">
            <div class="row row-cols-2"  style="position:absolute; right:15px"> 
                <div class="col">
                    <div class="dropdown">
                        <i type="button" data-bs-toggle="dropdown" class="fa-solid fa-bell icon_btn" style="margin:0px; padding:0px;">
                            <span class="bg-danger rounded-circle " style="font-size:8pt; padding:5px; margin-left:-7px; padding-top:2px; padding-bottom:2px;" id="notif_count">0</span>
                        </i>
