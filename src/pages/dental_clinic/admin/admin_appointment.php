<div class="page d-none" id="page_admin_appointment" style="background-color: white;">
        ...
        <div class="container" style="color: #7B7A7A; ">
            <div class="row">
                <div class="col mt-lg-5 mt-xl-5 mt-sm-3">
                    <span class="h2 ms-lg-5 fw-bold" style="letter-spacing: 2px; font-family: 'Work Sans', sans-serif;">APPOINTMENT</span>
                </div>
