<div class="side_bar_style_1 d-none d-xl-block  pt-3">
    <ul class="list-group pb-3" style="font-size: 1.4rem;">
        <li class="list-group-item border-top-0 btn_view_dashboard"><i title="View Dashboard" class="fa-fw fa-solid fa-house-chimney"></i></li>
